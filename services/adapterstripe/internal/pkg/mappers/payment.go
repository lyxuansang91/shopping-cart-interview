...
func MapProtoToDomainPayment(payment *adapterstripe.Payment) (*models.Payment, error) {
	if payment == nil {
		return nil, nil
	}
...
func MapDomainToProtoPayment(payment *models.Payment) *adapterstripe.Payment {
	if payment == nil {
		return nil
	}

	protoPayment := &adapterstripe.Payment{
