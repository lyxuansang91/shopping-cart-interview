...
import (
	...
	sqlcmodels "github.com/cinchprotocol/cinch-api/services/adapterstripe/internal/pkg/db"
)
...
func MapProtoToDomainPaymentMethod(paymentMethod *adapterstripe.PaymentMethod) (*models.PaymentMethod, error) {
...
func MapDomainToProtoPaymentMethod(paymentMethod *models.PaymentMethod) *adapterstripe.PaymentMethod {
	if paymentMethod == nil {
		return nil
	}

	return &adapterstripe.PaymentMethod{
