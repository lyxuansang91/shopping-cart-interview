...
import (
	...
	"github.com/cinchprotocol/cinch-api/services/adapterstripe/internal/app/controllers"
...
func StartGRPCServer(ctx context.Context) error {
	...
	ctx, span := tracing.StartFunctionSpan(ctx, "adapterstripe", "StartGRPCServer")
	defer span.End()
	...
	// Register services
	adapterstripeController := controllers.NewAdapterstripeController(
		app.Services.PaymentMethod,
		app.Services.Payment,
		app.Services.Refund,
	)
	pb.RegisterAdapterstripeServiceServer(grpcServer, adapterstripeController)
