...
import (
	...
	svcconfig "github.com/cinchprotocol/cinch-api/services/adapterstripe/configs"
	apprepositories "github.com/cinchprotocol/cinch-api/services/adapterstripe/internal/app/repositories"
...
func Init() error {
	...
	// Initialize tracing
	tp, err = tracing.InitTracer("adapterstripe", cfg.JaegerEndpoint)
	if err != nil {
		return err
	}
