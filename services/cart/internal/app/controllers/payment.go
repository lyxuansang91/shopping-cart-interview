...
func (c *PaymentController) CreatePayment(ctx context.Context, req *cart.CreatePaymentRequest) (*cart.CreatePaymentResponse, error) {
...
func (c *PaymentController) UpdatePayment(ctx context.Context, req *cart.UpdatePaymentRequest) (*cart.UpdatePaymentResponse, error) {
	// Convert proto Payment to models Payment
	payment, err := mappers.MapProtoToDomainPayment(req.Payment)
	if err != nil {
		return nil, err
